...
{
  public class ArrowTower : BasicAttackTower
  {
    private AnimatedSprite turret;

    public ArrowTower()
      : base("Sprites/Towers/arrowtower_base", 1, 1)
    {
      this.damageLookup = new int[5]{ 10, 20, 40, 75, 150 };
      ...
      this.attackSpeed = 1500f;
      this.type = TowerType.ARROW;
      this.turret = new AnimatedSprite("Sprites/Towers/arrowtower_turret", 1, 1);
      this.ground = true;
      this.air = true;
    ...
    public override Projectile CreateProjectile()
    {
      ...
      return (Projectile) new Arrow(GameMap.Instance, this.Damage(this.level, true), this.pos - new Vector2(0.0f, 13f), this.target, (BasicAttackTower) this);
    }
    ...
    public new static string Name() => "Arrow Tower";
