...
// Type: TowerDefense.DmgBoostTower
...
{
  public class DmgBoostTower : BasicAttackTower
  {
    protected float[] boostLookup = new float[1];

    public DmgBoostTower()
      : base("Sprites/Towers/boosttower_base", 1, 1)
    {
    ...
    public new static string Name() => "Damage Boost Tower";
