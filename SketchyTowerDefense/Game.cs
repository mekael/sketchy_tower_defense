...
namespace TowerDefense
{
  public class Game : Microsoft.Xna.Framework.Game
  {
    ...
    public Game()
    {
      ((Collection<IGameComponent>) this.Components).Add((IGameComponent) new GamerServicesComponent((Microsoft.Xna.Framework.Game) this));
    ...
    public void UpdateState()
    {
      ...
      {
        case Game.GameState.MAIN_MENU:
          Game.mainMenu = new MainMenu(this, (IServiceProvider) this.Services, StorageContainer.TitleLocation + "/Content");
          Game.gameMap = new GameMap(this, (IServiceProvider) this.Services, StorageContainer.TitleLocation + "/Content", 0);
          Game.gameMap.mainMenuMode = true;
          break;
        case Game.GameState.GAMEMAP:
          Game.gameMap = new GameMap(this, (IServiceProvider) this.Services, StorageContainer.TitleLocation + "/Content", this.levelToLoad);
          break;
      }
    ...
    protected override void Draw(GameTime gameTime)
    {
      ...
      this.spriteBatch.Begin(SpriteBlendMode.AlphaBlend, SpriteSortMode.Deferred, SaveStateMode.None, Matrix.CreateScale(this.globalScale) with
      {
        Translation = new Vector3((float) (-((double) this.globalScale * (double) this.dim.Width - (double) this.GraphicsDevice.Viewport.Width) / 2.0), (float) (-((double) this.globalScale * (double) this.dim.Height - (double) this.GraphicsDevice.Viewport.Height) / 2.0), 0.0f)
      });
      switch (this.state)
      {
        case Game.GameState.MAIN_MENU:
